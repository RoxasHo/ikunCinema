<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ArtisRegisterControl.ascx.cs" Inherits="masterpage1.ArtisRegisterControl" %>
...
<table style="width: 100%">
                  ...
                  <tr>
                      <td style="font-size: large" class="w3-center">Use the form below to create a new artist account.</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                      <td>
                          <asp:TextBox ID="RegisterIdentity" runat="server" style="font-size: x-large" Width="100%" placeholder=" Enter your IC number..."></asp:TextBox>
                      </td>
                  </tr>
                  <tr>
                      <td>
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Identity is required" ControlToValidate="RegisterIdentity" ForeColor="Red"></asp:RequiredFieldValidator>
                      </td>
                  </tr>
                  <tr>
