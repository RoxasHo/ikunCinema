<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AdminTimeTableDetail.aspx.cs" Inherits="CinemaTicketingSystem.AdminTimeTableDetailaspx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="adminHome">
        <div class="manageMovie">
                ...
                <ItemTemplate>
                    <div class="movie-container">
                        <div class="movie-item2">
                            <img src="<%# Eval("movieImage") %>" style="width: 20vw; height: 30vw; margin-top: 10px;" />
                        </div>
            ...
            <asp:LinkButton ID="AddButton" runat="server" CssClass="adminbutton3" OnClick="AddButton_Click">Add</asp:LinkButton>
        </div>
                ...
                <ItemTemplate>
                    <div class="timetable-item" style="width: 13vw; height: 9vw">
                        ...
                        <div class="timetable-info">
                            <asp:LinkButton ID="DeleteButton" runat="server" OnClick="DeleteButton_Click" CommandArgument='<%# Eval("timeTableID") %>'>
                                <div  class="noneLinkStyle adminbutton4" >
